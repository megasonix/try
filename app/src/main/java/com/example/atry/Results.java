...
public class Results extends AppCompatActivity {
    ...
    private static final String CLOUD_VISION_API_KEY = "AIzaSyArhKAq6Dio9U1oyiMxlfKJWzucSwtD7RI";
...
//        });
    ...
    private static class LableDetectionTask extends AsyncTask<Object, Void, String> {
        private final WeakReference<Results> mActivityWeakReference;
        private Vision.Images.Annotate mRequest;

        LableDetectionTask(Results activity, Vision.Images.Annotate annotate) {
        ...
        protected void onPostExecute(String result) {
            Results activity = mActivityWeakReference.get();
